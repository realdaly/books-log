...
export default function InventoryPage() {
    ...
    const COLUMNS = [
        ...
        { id: 'print_year', label: 'سنة الطبع', accessor: r => r.print_year || '-' },
                        ...
                        <table className="w-full text-right text-sm border-collapse border-b border-border">
                            <thead className="bg-primary text-primary-foreground sticky top-0 z-10 shadow-md">
                                <tr>
                                    ...
                                    <th onClick={(e) => handleColumnClick(3, e)} className={`p-4 text-center w-[75px] border-r border-primary-foreground/10 cursor-pointer transition-colors ${selectedCols.has(3) ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-900 dark:text-blue-100' : ''}`}>سنة الطبع</th>
