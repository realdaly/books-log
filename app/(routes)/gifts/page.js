...
export default function GiftsPage() {
    ...
    const filteredParties =
        query === ''
            ...
            }); // removed slice(0,50) to handle pagination manually
        ...
        >
            ...
            >
                <form onSubmit={handleSubmit} className="space-y-4">
                    {!editId && (
                        <div className="flex items-center justify-between bg-secondary/20 p-2 rounded-lg mb-2">
                    ...
                    <div>
                        <label className="block text-sm font-bold text-primary mb-1">الجهة المستلمة</label>
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                        ...
                        <div className="w-full md:w-32 flex flex-col gap-1">
                            <label className="block text-sm font-bold text-primary mb-1">صورة الطلب</label>
                            <div
