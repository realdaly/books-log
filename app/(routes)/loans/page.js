        ...
        <div className="space-y-6 h-full flex flex-col">
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-4">
                    <h1 className="text-3xl font-bold text-primary">سجل الاستعارة</h1>
                    ...
                    <table className="w-full text-right text-sm border-collapse border-b border-border">
                        <thead className="bg-primary text-primary-foreground font-bold sticky top-0 z-10 shadow-md">
                            <tr>
                                ...
                                <th className="p-4 border-l border-primary-foreground/10">عدد الاستعارة</th>
                                <th className="p-4 border-l border-primary-foreground/10">الجهة المستعيرة</th>
