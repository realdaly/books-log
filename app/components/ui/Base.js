...
export const Input = forwardRef(({ className, onFocus, ...props }, ref) => {
    return (
        <input
            ...
            className={cn(
                "flex h-10 md:h-11 w-full rounded-lg border-2 border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground outline-none focus-visible:border-primary focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-50 transition-all font-medium text-foreground",
                className
            )}
            {...props}
        />
...
export const Textarea = forwardRef(({ className, onFocus, ...props }, ref) => {
    return (
        <textarea
            ...
            className={cn(
                "flex min-h-[80px] w-full rounded-lg border-2 border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground outline-none focus-visible:border-primary focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-50 transition-all font-medium text-foreground",
                className
            )}
            {...props}
        />
